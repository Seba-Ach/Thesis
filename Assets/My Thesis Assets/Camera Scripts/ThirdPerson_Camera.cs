...
public class ThirdPerson_Camera : MonoBehaviour
{
    ...
    public float Distance = 10f;                             // Start distance of camera.
    public float DistanceMin = 7f;                          // Minimum distance of camera zoom.
    public float DistanceMax = 15f;                         // Maximum distance of camera zoom.
